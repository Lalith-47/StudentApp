...
const COSMOS_CONNECTION_STRING = "mongodb+srv://AdhyayanMargAdmin:%3CTeDxE85wcWtfmq7Q0g%23C%3E@adhyayanmarg-cosmos.global.mongocluster.cosmos.azure.com/?tls=true&authMechanism=SCRAM-SHA-256&retrywrites=false&maxIdleTimeMS=120000";
...
async function testCosmosConnection() {
  try {
    ...
    console.log("📡 Connection String:", COSMOS_CONNECTION_STRING.replace(/<TeDxE85wcWtfmq7Q0g#C>/, "***"));
    ...
    // Query test document
    const foundDoc = await TestModel.findOne({ name: 'Smart Student Hub Test' });
    if (foundDoc) {

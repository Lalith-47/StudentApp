            ...
            <Link to="/" className="flex items-center space-x-2 mb-4">
              <div className="w-8 h-8">
                <svg width="100%" height="100%" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  {/* Open Book (base) */}
                  <path d="M8 20C8 18.5 9.5 17 11 17H21C22.5 17 24 18.5 24 20V24C24 25.5 22.5 27 21 27H11C9.5 27 8 25.5 8 24V20Z" fill="#ffffff" stroke="#e5e7eb" stroke-width="0.5"/>
                  <path d="M8 20C8 18.5 9.5 17 11 17H21C22.5 17 24 18.5 24 20V24C24 25.5 22.5 27 21 27H11C9.5 27 8 25.5 8 24V20Z" fill="#fbbf24" opacity="0.3"/>
                  
                  {/* Book spine */}
                  <rect x="15" y="17" width="2" height="10" fill="#d97706"/>
                  
                  {/* Tree trunk */}
                  <path d="M15 20L17 20L17 24L15 24Z" fill="#ffffff"/>
                  
                  {/* Tree branches */}
                  <path d="M13 18L15 20L17 18L19 20L17 22L15 20Z" fill="#ffffff"/>
                  <path d="M12 16L14 18L16 16L18 18L16 20L14 18Z" fill="#ffffff"/>
                  ...
                  <circle cx="15" cy="18" r="1.5" fill="#10b981"/>
                  <circle cx="17" cy="18" r="1.5" fill="#10b981"/>
                </svg>
              </div>
